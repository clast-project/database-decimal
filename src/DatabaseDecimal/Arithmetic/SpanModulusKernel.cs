...
public static class SpanModulusKernel
{
        ...
        Span<int> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale32(left[i], ld) % Rescale32(right[i], rd);
        }
    }
        ...
        Span<long> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale64(left[i], ld) % Rescale64(right[i], rd);
        }
    }
        ...
        Span<Int128> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale128(left[i], ld) % Rescale128(right[i], rd);
        }
    }
        ...
        Span<Int256> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale256(left[i], ld) % Rescale256(right[i], rd);
        }
    }
        ...
        Span<long> result, DecimalType resultType)
    {
        ...
        for (int i = 0; i < left.Length; i++)
            result[i] = Widen32To64(left[i], ld) % Widen32To64(right[i], rd);
    }
        ...
        Span<Int128> result, DecimalType resultType)
    {
        ...
        for (int i = 0; i < left.Length; i++)
            result[i] = Widen64To128(left[i], ld) % Widen64To128(right[i], rd);
    }
        ...
        Span<Int256> result, DecimalType resultType)
    {
        ...
        for (int i = 0; i < left.Length; i++)
            result[i] = Widen128To256(left[i], ld) % Widen128To256(right[i], rd);
    }
        ...
        Span<int> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale32(left[i], ld) % rescaledRight;
        }
    }
        ...
        Span<long> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale64(left[i], ld) % rescaledRight;
        }
    }
        ...
        Span<Int128> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale128(left[i], ld) % rescaledRight;
        }
    }
        ...
        Span<Int256> result, DecimalType resultType)
    {
        ...
        {
            for (int i = 0; i < left.Length; i++)
                result[i] = Rescale256(left[i], ld) % rescaledRight;
        }
    }
